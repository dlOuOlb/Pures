...
static time_t TimP_Cast_Val_Obj_(timp_tm Obj) { return mktime(&Obj); }
#endif
...
#if(1)
static timp_tm TimP_TM_Current_(const _Bool Mode) { return TimP_Cast_Obj_Val_(TimP_Current_(),Mode); }
